...
import { getProjects, getCertificates, saveToLocalStorage, getFromLocalStorage } from "../localData";
...
const techStacks = [
  ...
  { icon: "Ros.svg", language: "ROS" },
  { icon: "Gazebo.svg", language: "Gazebo" },
  { icon: "Rasa.svg", language: "RASA" },
  { icon: "tiaportal.svg", language: "TIA Portal" },
  { icon: "solidworks.svg", language: "Catia" },
  ...
  { icon: "matlab.svg", language: "MATLAB & Simulink" },
  { icon: "fusion.webp", language: "Fusion 360" },
...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    // Check if the URL has a #Certificates hash when the component mounts
    if (window.location.hash === '#Certificates') {
      setValue(1); // Set to certificates tab (index 1)
    }
  }, []);
            ...
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-3 md:gap-5 gap-4">
                {displayedCertificates.map((certificate, index) => {
                  console.log("Certificate being rendered:", certificate);
                  return (
                    <div
                      key={index}
                      data-aos={index % 3 === 0 ? "fade-up-right" : index % 3 === 1 ? "fade-up" : "fade-up-left"}
